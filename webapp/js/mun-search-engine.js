                ...
                '<div class="modal-content modalinf">'+
                    ...
                    '<div class="modal-body">'+
                        ...
                        '<div class="input-group input-group-sm" style="margin-bottom: 15px;">'+
                            '<input autofocus id="search-county" onkeypress="SearchEngine.searchCountyByEnterKey(event)" type="text" class="form-control" placeholder="Search" style="margin: 2px 10px 0px 0px;height: 38px;">'+
                            '<label>'+
                                '<button class="btn btngreen" onclick="SearchEngine.searchCounty()" style="padding:8px 10px 1px 10px;"><i class="material-icons">search</i></button>'+
                            '</label>'+
                        '</div>'+
