var Translation={
	'pt-br':{
		...
		'txt29':'Fechar',
		'header-panel':'| Focos de Queimada',
		'header-menu':'Queimadas X Desmatamento <br> Queimadas X CAR',
		'header-title': 'Queimadas X Desmatamento - Queimadas X CAR',
		'maps-sup':'Mapas',
		...
		'by_car':'CAR',
		'by_prodes': 'Supressão da vegetação primária',
	...
	'en':{
		...
		'txt29':'Close',
		'header-panel':'| Active fires',
		'header-menu':'Fires X Vegetation Suppression <br> Fires X CAR',
		'header-title': 'Fires X Vegetation Suppression - Fires X CAR',
		'maps-sup':'Maps',
		'analysis-sup':'Graphs',
		...
		'by_car': 'CAR',
		'by_prodes': 'Suppression of primary vegetation',
