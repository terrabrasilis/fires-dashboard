var Translation={
	'pt-br':{
		...
		'downloadBtn':'Baixar a tabela de focos de queimada versus desmatamentos.',
		'txt5':'Imprimir',
		...
		'txt26a':'Baixar a tabela com os focos de queimada x desmatamento em formato CSV.',
		'txt26b':'Baixar arquivos dos imóveis rurais do CAR e agregados de desmatamento em formato matricial',
		'txt27':'Com filtros.',
		'txt28':'Sem filtros.',
		'txt28a':'Imóveis rurais do CAR com buffer de 500 metros.',
		'txt28b':'Agregado de desmatamentos PRODES.',
		'txt28c':'Agregado de desmatamentos DETER.',
		'txt29':'Fechar',
		'header-panel':'| Focos de Queimada (Queimadas X Desmatamentos X CAR)',
		'header-menu':'Queimadas X Desmatamentos X CAR',
		'maps-sup':'Mapas',
		...
		'radio-prodes':'Ver gráficos com base na contagem do número de focos em desmatamentos.',
		...
		'tituloprint':' | Focos de Queimada (Queimadas X Desmatamentos X CAR).',
	...
	'en':{
		...
		'title-chart': 'Daily deforestation active fires in the Brazilian Cerrado.',
		...
		'txt4p':'Print Graphs',
		'txt4s':'Print Graphs',
		'downloadBtn':'Download the active fires versus deforestations table.',
		'txt5':'Print',
		...
		'txt26':'Download data.',
		'txt26a':'Download data table with active fires in deforestation in CSV format.',
		'txt26b':'Download CAR rural properties and aggregated deforestation in matrix file format.',
		'txt27':'With filters.',
		'txt28':'Without filters.',
		'txt28a':'The CAR rural properties with 500 meters buffer.',
		'txt28b':'The aggregate deforestation of PRODES',
		'txt28c':'The aggregate deforestation of DETER.',
		'txt29':'Close',
		'header-panel':'| Active fires (Fires X Deforestations X CAR)',
		'header-menu':'Fires X Deforestations X CAR',
		'maps-sup':'Maps',
		'analysis-sup':'Graphs',
		...
		'radio-prodes':'See the charts based on sum of number of active fires on deforestations.',
		...
		'nv-aggregated-amz':'Cerrado Biome Active fires',
		'nv-aggreg-amz':'Amazon Biome',
		...
		'toDailyChart-cer':'Open the panel daily active fires for Cerrado Biome.',
		'tituloprint':' | Active fires (Fires X Deforestations X CAR).',
