var Translation={
	'pt-br':{
		...
		'txt15':'Análise - Focos de Queimada x Desmatamentos (PRODES Amazônia)',
		...
		'txt28':'Sem filtros.',
		'txt29':'Fechar',
		'header-panel':'| Focos de Queimada (Queimadas X PRODES)',
		'header-menu':'Queimadas X PRODES',
		'maps-sup':'Mapas',
		...
		'title_top_county':'Municípios com maior %dim%',
		'title_tot_state':'%Dim% por Estados',
		'title_top_uc':'Classes PRODES com maior %dim%',
		...
		'nv-daily-amz':'Focos na Amazônia Legal',
		...
		'toDailyChart-amz':'Abrir o painel focos mensais para a Amazônia Legal.',
		...
		'tituloprint':' | Focos de Queimada na Amazônia Legal (Queimadas X PRODES).',
		...
		'general-info-label':'Informações importantes',
	...
	'en':{
		...
		'txt15':'Analyses - Focuses of Fires x Deforestations (PRODES Amazon)',
		...
		'txt29':'Close',
		'header-panel':'| Focuses of Fires (Fires X PRODES)',
		'header-menu':'Fires X PRODES',
		'maps-sup':'Maps',
		'analysis-sup':'Graphs',
		...
		'title_top_county':'Municipalities with the greatest %dim%',
		'title_tot_state':'%Dim% by States',
		'title_top_uc':'PRODES classes with the greatest %dim%',
		...
		'nv-daily-amz':'Legal Amazon Focuses',
		...
		'toDailyChart-amz':'Open the monthly focuses panel for Legal Amazon.',
		...
		'tituloprint':' | Focuses of Fires in the Legal Amazon (Fires X PRODES).',
		...
		'general-info-label':'Relevant informations',
