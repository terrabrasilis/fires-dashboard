var Translation={
	...
	'en':{
		...
		'txt4p':'Print Graphs',
		'txt4s':'Print Graphs',
		'downloadBtn':'Download the focuses of fires versus deforestations table.',
		'txt5':'Print',
		...
		'title_chart_main':'Analyses - Focuses of Fires x %dim% (Amazon Biome)',
		...
		'txt29':'Close',
		'header-panel':'| Focuses of Fires (Fires X Deforestations X CAR)',
		...
		'nv-aggregated-amz':'Amazon Biome Focuses',
		...
		'toAggregatedChart-amz':'Open the monthly focuses panel for Amazon Biome.',
		'toAggregatedChart-amz':'Open the panel aggregate monthly focuses for Amazon Biome.',
		...
		'tituloprint':' | Focuses of Fires in the Amazon Biome (Fires X Deforestations X CAR).',
