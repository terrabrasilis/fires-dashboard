var Translation={
	'pt-br':{
		...
		'tituloprint':' | Focos de Queimada na Amazônia Legal (Queimadas X Desmatamentos X CAR).',
	...
	'en':{
		...
		'tituloprint':' | Focuses of Fires in the Legal Amazon (Fires X Deforestations X CAR).',
