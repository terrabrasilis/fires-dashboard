var Translation={
	'pt-br':{
		...
		'title_chart_main':'Análise - Focos de Queimada x %dim% (Bioma Amazônia)',
		...
		'toAggregatedChart-amz':'Abrir o painel focos mensais para o Bioma Amazônia.',
		...
		'tituloprint':' | Focos de Queimada no Bioma Amazônia (Queimadas X Desmatamentos X CAR).',
	...
	'en':{
		...
		'title_chart_main':'Analyses - Active fires x %dim% (Amazon Biome)',
		...
		'toAggregatedChart-amz':'Open the monthly active fires panel for Amazon Biome.',
		...
		'tituloprint':' | Active fires in the Amazon Biome (Fires X Deforestations X CAR).',
