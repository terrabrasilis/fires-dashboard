var Translation={
	'pt-br':{
		...
		'downloadBtn':'Baixar a tabela de focos de queimada versus supressão da vegetação nativa.',
		'txt5':'Imprimir',
		...
		'txt26a':'Baixar a tabela com os focos de queimada x supressão da vegetação nativa em formato CSV.',
		'txt26b':'Baixar arquivos dos imóveis rurais do CAR e agregados de supressão da vegetação nativa em formato matricial',
		'txt27':'Com filtros.',
		'txt28':'Sem filtros.',
		'txt28a':'Imóveis rurais do CAR com buffer de 500 metros.',
		'txt28b':'Agregado de supressão da vegetação nativa PRODES.',
		'txt28c':'Agregado de supressão da vegetação nativa DETER.',
		'txt29':'Fechar',
		...
		'analysis-des':'Supressão da Vegetação Nativa',
		'analysis-war':'DETER (Avisos)',
		'analysis-fire':'Focos (Queimada)',
		'map-des':'Supressão da Vegetação Nativa',
		...
		'radio-prodes':'Ver gráficos com base na contagem do número de focos em supressão da vegetação nativa.',
		...
		'bydata': 'Supressão da vegetação nativa',
		'by_car':'CAR',
		'by_prodes': 'Supressão da vegetação nativa',
