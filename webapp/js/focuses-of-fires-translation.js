var Translation={
	'pt-br':{
		...
		'downloadBtn':'Baixar a tabela de focos de queimada versus supressão da vegetação primária.',
		'txt5':'Imprimir',
		...
		'title_chart_main':'Análise - Focos de Queimada x %dim%',
		...
		'txt26a':'Baixar a tabela com os focos de queimada x supressão da vegetação primária em formato CSV.',
		'txt26b':'Baixar arquivos dos imóveis rurais do CAR e agregados de supressão da vegetação primária em formato matricial',
		'txt27':'Com filtros.',
		'txt28':'Sem filtros.',
		'txt28a':'Imóveis rurais do CAR com buffer de 500 metros.',
		'txt28b':'Agregado de supressão da vegetação primária PRODES.',
		'txt28c':'Agregado de supressão da vegetação primária DETER.',
		'txt29':'Fechar',
		'header-panel':'| Focos de Queimada (Queimadas X Supressão da Vegetação Primária X CAR)',
		'header-menu':'Queimadas X Supressão da Vegetação Primária X CAR',
		'maps-sup':'Mapas',
		'analysis-sup':'Gráficos',
		'analysis-des':'Supressão da Vegetação Primária',
		'analysis-war':'DETER (Avisos)',
		'analysis-fire':'Focos (Queimada)',
		'map-des':'Supressão da Vegetação Primária',
		...
		'radio-prodes':'Ver gráficos com base na contagem do número de focos em supressão da vegetação primária.',
		...
		'bydata': 'Supressão da Vegetação Primária',
		'by_car':'Por CAR',
		'by_prodes': 'Por Supressão da Vegetação Primária',
		...
		'title_top_cls':'Classes com maior número de focos',
		...
		'nv-aggregated-br':'Brasil',
		'nv-aggregated-amz':'Bioma Amazônia',
		'nv-aggregated-cer':'Bioma Cerrado',
		'nv-aggregated-pan':'Bioma Pantanal',
		'nv-aggregated-caa':'Bioma Caatinga',
		'nv-aggregated-mat':'Bioma Mata Atlântica',
		'nv-aggregated-pam':'Bioma Pampa',
		...
		'toAggregatedChart-br':'Abrir o painel agregado mensal de focos para o Brasil.',
		'toAggregatedChart-amz':'Abrir o painel agregado mensal de focos para o bioma Amazônia.',
		'toAggregatedChart-cer':'Abrir o painel agregado mensal de focos para o bioma Cerrado.',
		'toAggregatedChart-pan':'Abrir o painel agregado mensal de focos para o bioma Pantanal.',
		'toAggregatedChart-caa':'Abrir o painel agregado mensal de focos para o bioma Caatinga.',
		'toAggregatedChart-mat':'Abrir o painel agregado mensal de focos para o bioma Mata Atlântica.',
		'toAggregatedChart-pam':'Abrir o painel agregado mensal de focos para o bioma Pampa.',
		'tituloprint':' | Focos de Queimada (Queimadas X Supressão da Vegetação Primária X CAR).',
	...
	'en':{
		/* texts into HTML entities */
		'display-general-info':'Understand these data and analyses by clicking on this box.',
		...
		'txt4p':'Print Graphs',
		'txt4s':'Print Graphs',
		'downloadBtn':'Download the active fires versus suppression of primary vegetation table.',
		'txt5':'Print',
		...
		'title_chart_main':'Analyses - Active fires x %dim%',
		...
		'txt26':'Download data.',
		'txt26a':'Download data table with active fires in suppression of primary vegetation in CSV format.',
		'txt26b':'Download CAR rural properties and aggregated suppression of primary vegetation in matrix file format.',
		'txt27':'With filters.',
		'txt28':'Without filters.',
		'txt28a':'The CAR rural properties with 500 meters buffer.',
		'txt28b':'The aggregate suppression of primary vegetation of PRODES',
		'txt28c':'The aggregate suppression of primary vegetation of DETER.',
		'txt29':'Close',
		'header-panel':'| Active fires (Fires X Suppression of Primary Vegetation X CAR)',
		'header-menu':'Fires X Suppression of Primary Vegetation X CAR',
		'maps-sup':'Maps',
		'analysis-sup':'Graphs',
		'analysis-des':'Suppression of primary vegetation',
		'analysis-war':'DETER (Notices)',
		'analysis-fire':'Active fires',
		'map-des':'Suppression of primary vegetation',
		...
		'radio-prodes':'See the charts based on sum of number of active fires on suppression of primary vegetation.',
		'radio-car':'See the charts based on sum of number of active fires in rural properties of the CAR.',
		'print_page':'Print this page using the browser resources.',
		/* Texts inside javascript. */
		'areas':'area',
		'notice':'alert',
		'num_focus':'Number of active fires',
		'percent':'(corresponds to 100% for the purpose of calculating fractions)',
		'numpolygons':'Total number of active fires (filters change this value)',
		'unit_focus':'active fires',
		'yyyymm':'Year/month',

		'bydata': 'Suppression of primary vegetation',
		'by_car': 'By CAR',
		'by_prodes': 'By Suppression of primary vegetation',
		...
		'timeline_header':'Distribution of the number of active fires over time.',
		'timeline_desc':'Interval:',
		'title_tot_class':'Classes by number of active fires',
		'title_top_county':'Municipalities with the greatest number of active fires',
		'title_tot_state':'Number of active fires by States',
		'title_top_cls':'Classes with the greatest number of active fires',
		...
		'nv-chart-day':'Graphs - Monthly Active fires',
		'nv-aggregated-br':'Brazil',
		'nv-aggregated-amz':'Amazon biome',
		'nv-aggregated-cer':'Cerrado biome',
		'nv-aggregated-pan':'Pantanal biome',
		'nv-aggregated-caa':'Caatinga biome',
		'nv-aggregated-mat':'Mata Atlântica biome',
		'nv-aggregated-pam':'Pampa biome',
		...
		'toAggregatedChart-br':'Open the panel aggregate monthly active fires for Brazil.',
		'toAggregatedChart-amz':'Open the panel aggregate monthly active fires for Amazon biome.',
		'toAggregatedChart-cer':'Open the panel aggregate monthly active fires for Cerrado biome.',
		'toAggregatedChart-pan':'Open the panel aggregate monthly active fires for Pantanal biome.',
		'toAggregatedChart-caa':'Open the panel aggregate monthly active fires for Caatinga biome.',
		'toAggregatedChart-mat':'Open the panel aggregate monthly active fires for Mata Atlântica biome.',
		'toAggregatedChart-pam':'Open the panel aggregate monthly active fires for Pampa biome.',
		'tituloprint':' | Active fires (Fires X Suppression of Primary Vegetation X CAR).',
